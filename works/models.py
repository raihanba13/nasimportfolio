...
class Work(models.Model):
    ...
    content = models.TextField(unique=True, blank=True, null=True)
    live = models.TextField(unique=True, blank=True, null=True)
    downloadOrView = models.TextField(unique=True, blank=True, null=True)
